...
RSpec.describe 'The landing page' do
  before :each do
    @fred = User.create!(name: 'Fred Jonson', email: 'fred.jonson@gmail.com', password: 'test', password_confirmation: 'test')
    @billy = User.create!(name: 'Billy Jones', email: 'billy.jones@gmail.com', password: 'test', password_confirmation: 'test')
    @sammy = User.create!(name: 'Sammy Jones', email: 'sammy.jones@gmail.com', password: 'test', password_confirmation: 'test')
