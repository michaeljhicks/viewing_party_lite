...
RSpec.describe 'Landing Page' do
  before(:each) do
    ...
    @user1 = User.create!(name: 'Mike', email: 'mike@example.com', password: 'test', password_confirmation: 'test')
    @user2 = User.create!(name: 'Gunnar', email: 'gunnar@example.com', password: 'test', password_confirmation: 'test')
